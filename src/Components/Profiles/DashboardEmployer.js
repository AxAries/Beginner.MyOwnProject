            ...
            <h1 className="Profile_Heading">
                ...
                <div className="Profile_Container">
                    ...
                    <div className="ProfileEmployer_Options">
                        ...
                        <h1>Ogłoszenia</h1>
                        <img className="ProfileEmployer_Options-Image" src={myaplication} alt="logo" />
                        <button>Otwórz</button>
                        </div>
                        <div className="ProfileEmployer_Options-AddAnnouncements">
                        <h1>Dodaj nowe ogłoszenie</h1>
                        <img className="ProfileEmployer_Options-Image" src={save} alt="logo" />
                        <button>Otwórz</button>
                        </div>
                        <div className="ProfileEmployer_Options-Candidates">
                        <h1>Kandydaci</h1>
                        <img className="ProfileEmployer_Options-Image" src={filedocuments} alt="logo" />
                        <button>Otwórz</button>
                        </div>
                    </div>
